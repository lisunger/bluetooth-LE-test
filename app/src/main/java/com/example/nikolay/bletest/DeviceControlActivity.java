...
public class DeviceControlActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mEditText = findViewById(R.id.textData);
        ...
        mButtonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mMyCharacteristic.setValue(mEditText.getText().toString());
    ...
    private void onServicesDiscovered(List<BluetoothGattService> gattServices) {
        // TODO check for null
        mMyCharacteristic = gattServices.get(2).getCharacteristics().get(0);
        int properties = mMyCharacteristic.getProperties();
